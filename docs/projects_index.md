...
전자, 로보틱스, 메이커 프로젝트 모음입니다. 
각 프로젝트를 클릭하면 회로도, 코드, 문서가 있는 GitHub 저장소로 이동합니다.
...
<br>
- [기상 정보 디스플레이 장치](https://github.com/LeeMakeKR/Weather_Station) (last updated: 26/07/08)
<br>
- [공기질 모니터](https://github.com/LeeMakeKR/Air_Quality_Monitor) (last updated: 26/06/08)
 타오바오에서 새 센서 구입, 모듈 도착하면 추가 예정
<br>
- [UBTECH CAN 서보프로토콜 분석과 제어](https://github.com/LeeMakeKR/UBTECH_CAN_Servo) (last updated: 26/06/08)
<br>
- [범용 I2C 키보드](https://github.com/LeeMakeKR/universal-i2c-keyboard) (last updated: 26/06/08)
<br>
...
<br>
- [클래식 계산기](https://github.com/LeeMakeKR/Classic_Calculator) (비공개) (last updated: 25/11/12)
<br>
- [3D 프린팅 챔버 온도 및 공기 정화 시스템](https://github.com/LeeMakeKR/3d-printing-chamber-temperature-and-air-filtration-system) (비공개) (last updated: 25/10/27)
<br>
- [뮤직 박스 펀처](https://github.com/LeeMakeKR/Music_Box_Puncher) (비공개) (last updated: 25/08/07)
...
- 위치추적 마이크
  ...
  - 강도 기반 3-mic 방향 추정 — https://github.com/mahdi943/soundlocalization
...
- Home Assistant 통합 모니터링 센서

- 샤오미 온습도 센서 Home Assistant 변경 펌웨어 업데이트

- 버드하우스 LoRaWAN
  - 참조: https://hackaday.io/project/185881-lorawan-birdhouse
